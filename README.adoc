= RISC-V Logic Analyzer Trace Specification

This repository contains the RISC-V Logic Analyzer Trace specification, developed by the Logic Analyzer Trace Task Group under the SOC Infrastructure Horizontal Committee. This is a non-ISA specification.

* Jira: https://riscv.atlassian.net/browse/RVS-4762[RVS-4762] (specification) / https://riscv.atlassian.net/browse/RVG-971[RVG-971] (task group)
* Mailing list: https://lists.riscv.org/g/tech-logic-analyzer-trace[tech-logic-analyzer-trace]
* Confluence: https://riscv.atlassian.net/wiki/spaces/LATR[LATR space]
